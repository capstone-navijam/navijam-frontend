        ...
        <div className="relative flex h-screen">
            ...
            <article
                className={`absolute top-0 left-0 ${
                    isTabletHeight && isBookmarkClicked
                        ? "z-20 transform translate-x-0 w-[80%]"
                        : "z-10 transform -translate-x-full"
            ...
            <section
                className={`relative w-full ${
                    isTabletHeight && isBookmarkClicked ? "z-10 opacity-50" : "z-20 opacity-100"
