                    ...
                    <div className="flex flex-col h-full mt-10 w-full mx-auto text-nowrap">
                        <div className="px-6 py-8 rounded border-yellow-6 border-2 shadow-xl text-black w-full">
                            ...
                            <div className="flex flex-col">
                                ...
                                <p className="text-2xl mt-1 self-end">
                                    <span className="text-red-500">*</span> 은 필수 항목입니다.
                                </p>
                            </div>
                            <div className="gap-16 flex flex-col">
                                ...
                                <div className="flex flex-col gap-12 w-full">
                                    <div className="flex items-center">
                                        <label htmlFor="email" className="text-2xl font-semibold w-40 text-wrap">
                                            아이디<br/>(이메일)<span className="text-red-500">*</span>
                                        </label>
                    ...
                    <div className="flex flex-col h-full mt-10 w-[60%] mx-auto text-nowrap mb-10">
                        <div className="px-6 py-8 rounded border-yellow-6 border-2 shadow-xl text-black w-full">
                            ...
                            <div className="gap-16 flex flex-col">
                                ...
                                <div className="flex flex-col gap-12 w-full">
                                    <div className="flex items-center">
                                        <label htmlFor="email" className="text-3xl font-semibold w-40 text-wrap">
                                            아이디<br/>(이메일)<span className="text-red-500">*</span>
                                        </label>
                                        <div className="w-full">
                                            <div className="flex items-center gap-1">
