...
export default function MainComfort() {
    ...
    return (
        <section className={`mt-16 flex flex-col items-center ${isTablet ? 'mb-16' : ''}  text-center`}>
            <div>
                <h1 className={`font-semibold text-yellow-6 italic mb-8 ${isTablet ? 'text-5xl' : 'text-7xl'}`}>오늘 하루
                    힘드셨나요 ?</h1>
